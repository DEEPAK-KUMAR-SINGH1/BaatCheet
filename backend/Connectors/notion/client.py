"""
Notion OAuth and API helpers for the connector.

Configure a Notion public integration and provide its OAuth client ID and secret
...
def _load_client_config() -> tuple[str, dict[str, Any]]:
    return "web", oauth_client_config("NOTION", "Notion", REDIRECT_URI, AUTH_URI, TOKEN_URI)
...
def get_notion_tools() -> list:
    """Return a list of LangChain tools for Notion."""
