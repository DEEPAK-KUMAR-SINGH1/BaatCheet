"""
LinkedIn OAuth and API helpers for the connector.

Configure a LinkedIn developer app and provide its OAuth client ID and secret
...
from Connectors.oauth import oauth_client_config
...
def _load_client_config() -> tuple[str, dict[str, Any]]:
    return "web", oauth_client_config("LINKEDIN", "LinkedIn", REDIRECT_URI, AUTH_URI, TOKEN_URI)
...
def get_linkedin_tools() -> list:
    """Return a list of LangChain tools for LinkedIn."""
